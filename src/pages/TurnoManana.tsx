...
const cicloOrientado = [
  { año: "4º Año", divisiones: ["Ciencias Naturales"] },
  { año: "5º Año", divisiones: ["Ciencias Naturales"] },
  { año: "6º Año", divisiones: ["Ciencias Naturales"] },
];

export default function TurnoManana() {
  return (
    <>
      <section className="bg-primary text-primary-foreground">
        <div className="container py-16 md:py-20">
          ...
          <p className="text-primary-foreground/70 text-lg">
            Horario de ingreso: 7:30 hs — Horario de salida: 12:30 hs
          </p>
        </div>
      </section>
      ...
      <section className="container py-16 md:py-20 space-y-12">
        ...
        <CicloSection title="Ciclo Orientado — Ciencias Naturales" items={cicloOrientado} />
      </section>
    </>
  );
}
